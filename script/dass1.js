...
$( document ).ready(function() {
	...
	$(".alert_box_big").hide();
	$(function(){
		// change the background of the item
		$("input[name='1st']").change(function(){
			$("#1st").css("background-color","#e5e6d0");
		})
		$("input[name='2nd']").change(function(){
			$("#2nd").css("background-color","#e5e6d0");
		})
		$("input[name='3rd']").change(function(){
			$("#3rd").css("background-color","#e5e6d0");
		})
		$("input[name='4th']").change(function(){
			$("#4th").css("background-color","#e5e6d0");
		})
		$("input[name='5th']").change(function(){
			$("#5th").css("background-color","#e5e6d0");
		})
		$("input[name='6th']").change(function(){
			$("#6th").css("background-color","#e5e6d0");
		})
		$("input[name='7th']").change(function(){
			$("#7th").css("background-color","#e5e6d0");
		})
		$("input[name='8th']").change(function(){
			$("#8th").css("background-color","#e5e6d0");
		})
		$("input[name='9th']").change(function(){
			$("#9th").css("background-color","#e5e6d0");
		})
		$("input[name='10th']").change(function(){
			$("#10th").css("background-color","#e5e6d0");
		})
		$("input[name='11th']").change(function(){
			$("#11th").css("background-color","#e5e6d0");
		})
		$("input[name='12th']").change(function(){
			$("#12th").css("background-color","#e5e6d0");
		})
		$("input[name='13th']").change(function(){
			$("#13th").css("background-color","#e5e6d0");
		})
		$("input[name='14th']").change(function(){
			$("#14th").css("background-color","#e5e6d0");
		})
		$("input[name='15th']").change(function(){
			$("#15th").css("background-color","#e5e6d0");
		})
		$("input[name='16th']").change(function(){
			$("#16th").css("background-color","#e5e6d0");
		})
		$("input[name='17th']").change(function(){
			$("#17th").css("background-color","#e5e6d0");
		})
		$("input[name='18th']").change(function(){
			$("#18th").css("background-color","#e5e6d0");
		})
		$("input[name='19th']").change(function(){
			$("#19th").css("background-color","#e5e6d0");
		})
		$("input[name='20th']").change(function(){
			$("#20th").css("background-color","#e5e6d0");
		})
		$("input[name='21th']").change(function(){
			$("#21th").css("background-color","#e5e6d0");
		})
		$("input[name='22th']").change(function(){
			$("#22th").css("background-color","#e5e6d0");
		})
		$("input[name='23th']").change(function(){
			$("#23th").css("background-color","#e5e6d0");
		})
		$("input[name='24th']").change(function(){
			$("#24th").css("background-color","#e5e6d0");
		})
		$("input[name='25th']").change(function(){
			$("#25th").css("background-color","#e5e6d0");
		})
		$("input[name='26th']").change(function(){
			$("#26th").css("background-color","#e5e6d0");
		})
		$("input[name='27th']").change(function(){
			$("#27th").css("background-color","#e5e6d0");
		})
		$("input[name='28th']").change(function(){
			$("#28th").css("background-color","#e5e6d0");
		})
		$("input[name='29th']").change(function(){
			$("#29th").css("background-color","#e5e6d0");
		})
		$("input[name='30th']").change(function(){
			$("#last_item").css("background-color","#e5e6d0");
		})
		...
		$("form#dass_ques").submit(function(){
			...
			// get the value for each item in the questionnaire
